...
export default function Chart() {
  ...
  const getActivity = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        const sportsDurationChartData = Object.keys(sportsDurationData).map((date) => ({
          date,
  ...
  useEffect(() => {
    ...
    const filteredData = filterDataByDateRange(waterData, startDate, endDate);
    setFilteredData(filteredData);
  }, [startDate, endDate, waterData]);
